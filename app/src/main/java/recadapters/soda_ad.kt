...
import com.example.coffee_break.soda
import com.example.coffee_break.soda_drinks

class soda_ad(val context: Context, val list:ArrayList<soda>) : RecyclerView.Adapter<soda_ad.MyVH>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): soda_ad.MyVH {
    ...
    override fun onBindViewHolder(holder: soda_ad.MyVH, position: Int) {
